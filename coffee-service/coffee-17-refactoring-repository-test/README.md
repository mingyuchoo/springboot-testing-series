...
## coffeeServiceImpl-01-improve-gradle
...
## coffeeServiceImpl-02-adjust-logging
...
## coffeeServiceImpl-03-implement-a-class
...
## coffeeServiceImpl-04-add-jacoco
...
## coffeeServiceImpl-05-add-repo-to-jenkins
...
public class CoffeeController {
    ...
    public List<CoffeeEntity> findAll() throws IOException {
        CoffeeService coffeeServiceImpl  = new CoffeeService();
        return coffeeServiceImpl.findAll();
    }
}
```

* CoffeeControllerTest (This is using WebTestClient)
