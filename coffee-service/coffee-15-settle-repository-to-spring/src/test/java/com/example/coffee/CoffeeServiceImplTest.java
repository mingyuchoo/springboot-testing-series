...
// @ExtendWith(MockitoExtension.class) // Mockito 를 쓸 때, 주석해제하세요.
class CoffeeServiceImplTest {
    ...
    void testFindAll() throws Exception {
        ...
        Assertions.assertNotNull(coffeeServiceImpl.findAll());
        Assertions.assertEquals(12, coffeeServiceImpl.findAll().size());
    }
